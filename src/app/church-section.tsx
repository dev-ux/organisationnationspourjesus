            ...
            <div className="relative overflow-hidden rounded-2xl bg-white p-8 sm:p-10">
              ...
              <div className="relative">
                <div className="flex items-center gap-x-4 mb-8">
                  <div className="flex-none rounded-lg bg-indigo-50 p-3">
                    <svg className="h-6 w-6 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a4.125 4.125 0 00-7.5-0v2.625c0 .621.504 1.125 1.125 1.125h2.25a2.25 2.25 0 002.25-2.25V8.25m-9 4.5h7.5M7.5 21h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9a2.25 2.25 0 00-2.25 2.25v9a2.25 2.25 0 002.25 2.25z" />
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold leading-8 tracking-tight text-gray-900">
